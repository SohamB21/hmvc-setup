...
<div class="panel panel-primary">
	<div class="panel-heading">
		Student List
		<a href="<?= base_url('student/add-student') ?>" style="margin-top: -7px;" class="btn btn-info pull-right">
			Add Student
		</a>
	</div>
				...
				?>
						<tr>
							...
							<td>
								...
								<a href="#" class="btn btn-danger" onclick="if(confirm('Are you sure about deleting the student information?')){ 
